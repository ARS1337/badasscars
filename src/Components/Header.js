      ...
      <div className="block md:hidden lg:hidden pt-2 ">
        <div className="flex items-start justify-between px-2">
          <div className="order-2 hover:cursor-pointer relative flex justify-end">
            ...
            <select className=" bg-CorrectBlack  p-2 px-4 w-1/2  text-white font-oswald shadow-lg  z-50 hover:cursor-pointer border-0">
              <option value="B2B" className="px-2 font-bold text-white font-oswald z-50">
                B2B
              </option>
              <option value="B2B" className="px-2 font-bold text-white font-oswald z-50">
                CLICK & CONNECT
